...
- [ ] Add gum dependency checks, log directory creation, and run header output (see 2.1, 2.3, 4).
- [ ] Create UI helper module and wire into `scripts/agent-loop.sh` for headers/status lines (see 2.1, 2.3, 4.2).
