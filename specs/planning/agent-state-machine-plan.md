...
- [ ] Add Rust enums/structs for `AgentStateKind`, `AgentEvent`, `AgentAction`, `ToolRunStatus` (See §3)
- [ ] Implement `handle_event` transition function in `app/src-tauri/src/agent_state.rs` (See §5)
