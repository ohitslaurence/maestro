...
- [x] Remove stream-driven status tracking from `useOpenCodeThread`, keeping it focused on
...
- [x] Ensure state transition logs include `session_id` and `stream_id` for triage (see
